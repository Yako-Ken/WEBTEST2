...
function CustomizeProducts() {
  return (
    <div className='flex flex-col gap-6'>
      <h4 className='font-medium'>Chosse a Color</h4>
    ...
    <li className='w-8 h-8 rounded-full ring-1 ring-gray-300 cursor-not-allowed relative bg-purple-500'>
      ...
      <ul className='flex items-center gap-3'>
        <li className='ring-1 ring-importantcolor text-importantcolor rounded-md py-1 px-4 text-sm cursor-pointer'>Small</li>
        <li className='ring-1 ring-importantcolor text-white bg-importantcolor rounded-md py-1 px-4 text-sm cursor-pointer'>Medium</li>
